...
const AddNewForum = () => {
    ...
    return (
        <div className="bg-gray-100 py-10 lg:px-0 px-5">
            {/* <h2 className="text-4xl text-center font-bold mb-5">Add New Forum</h2> */}
            <div className="lg:w-3/4 mx-auto bg-white rounded-md p-6 shadow-md">
                <form onSubmit={handlePost} action="#" method="POST">
                    ...
                    <button type="submit" className="bg-[#ffd166] font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 w-full">Post</button>
                </form>
            </div>
            <Helmet>
